...
export default function TautkanMataPelajaranPage() {
    ...
    const handleKelasChange = async (value: string) => {
        setFormData((prev) => ({ ...prev, id_kelas: value, id_mapel: ""}))
    ...
    const handleAlertClose = () => {
        ...
        if (alertData.isSuccess) {
            router.push("/mata_pelajaran/tautkan_mata_pelajaran")
            router.refresh()
        }
    }
                            ...
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex justify-end pt-4">
                                        <Button
                                            type="submit"
                                            disabled={isLoading || !formData.id_mapel}
