...
export default function CreateBabPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault()
        if (!formData.id_kelas || !formData.id_mapel || !formData.nama_bab) {
            setAlertData({
                title: "Gagal",
                ...
                <main className="flex-1 p-4 md:p-6">
                    <div className="mx-auto max-w-auto">
                        ...
                        <Card className="border-t-4 border-t-primary shadow-md">
                            <CardHeader>
                                <CardTitle>Formulir Bab</CardTitle>
                                <CardDescription>
                                    Silakan pilih kelas dan mata pelajaran, lalu isi nama bab baru.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="nama_bab">Nama Bab <span className="text-red-500">*</span></Label>
                                        <Input
                                            id="nama_bab"
                                            name="nama_bab"
                                            value={formData.nama_bab}
                                            onChange={handleChange}
                                            placeholder="Contoh : Fungsi kata di"
                                            disabled={!formData.id_mapel}
                                        />
                                        {!formData.id_mapel && (
                                            <p className="text-xs text-muted-foreground">
                                                Pilih Mata Pelajaran terlebih dahulu untuk mengisi nama bab.
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex justify-end pt-4">
                                        <Button
                                            type="submit"
                                            disabled={isLoading || !formData.nama_bab}
