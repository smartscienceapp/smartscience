...
export default function CreateTobPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const kelasRes = await axios.get("http://127.0.0.1:8000/api/v1/users/get_kelas_detail")
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post("http://127.0.0.1:8000/api/v1/tob/create_tob", payload)
            setIsLoading(false)
        ...
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-1 flex-col">
                <header className="flex h-16 items-center justify-between border-b border-border bg-background px-6">
                    <h1 className="text-2xl font-semibold">Buat TOB Baru</h1>
                    <UserMenu />
                </header>
